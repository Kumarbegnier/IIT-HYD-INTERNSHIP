...
Find the locus of all the unit vectors in the xy-plane%
\section{Solution}
%
Given that,  $\vec{a}=1$, $z=0$\\
Let, point "D" which perpendicular to the $OB$ with $OA= \vec{a}$, $OD = x$, $AD = y$, $A(x,y)$\\
%
We know that,
%
\begin{equation}
...
\end{figure}
%
This equation similar to the circle equation
...
\end{equation}
%
putting these x and y  value in the equation (2.0.2)
\begin{equation}
\vec{a} = cos{AOD}\vec{i}+sin{AOD}\vec{j}
\end{equation}
%
For all unit vector ($0$ to $2\pi$)
\\
\end{document}
